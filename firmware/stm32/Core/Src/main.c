...
#define FORWARD_STATE HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_9)
#define LEFT_STATE HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_7)
#define RIGHT_STATE HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_8)
#define BACKWARD_STATE HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_7)
...
int main(void)
{
 ...
 //int32_t CH1_DC = 0;
  ...
  void LEFT_DIR(void)
    {
    	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_8|GPIO_PIN_4,  GPIO_PIN_RESET);
    	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_14|GPIO_PIN_5,  GPIO_PIN_SET);
    	TIM2->CCR1 = 10;
    	TIM2->CCR2 = 80;
    	// GIVE PWMA AND PWMB 
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  ...
	  if(FORWARD_STATE == 0 && LEFT_STATE == 0 && RIGHT_STATE == 0 && BACKWARD_STATE == 0)
		  {
		      STOP();
		  }
    /* USER CODE BEGIN 3 */
